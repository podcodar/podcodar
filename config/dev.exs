...
config :podcodar, PodcodarWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "hbttbLoMVbsZy1KF/vKi4Bxg5CB+3itQbhpBSTqFRDCUJKQhLx8FzWk9Kh8e6HoD",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:podcodar, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:podcodar, ~w(--watch)]}
  ]
...
config :podcodar, PodcodarWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/podcodar_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :podcodar, dev_routes: true
...
config :website, WebsiteWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "waWrLhe2ZrVuXsk+TGJH7O5jZ3vA+q/f1DrJatCdkpiuvpbXVd6FTIIeuvHnh5PT",
  watchers: [
